...
class StoreBundleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'bundle_type' => 'required|string|in:production,template,sample_pack,tutorial,remix_stems',
    ...
    public function messages(): array
    {
        return [
            ...
            'bundle_type.required' => 'A bundle type is required.',
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            if (!$this->is_free && (!$this->bundle_price || $this->bundle_price <= 0)) {
