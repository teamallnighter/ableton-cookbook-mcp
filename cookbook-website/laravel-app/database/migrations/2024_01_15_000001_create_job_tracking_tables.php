...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('job_error_logs')) {
        ...
        if (!Schema::hasTable('job_notifications')) {
        ...
        if (!Schema::hasTable('job_system_metrics')) {
        ...
        Schema::table('racks', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('racks', 'processing_status')) {
            ...
            // Job tracking
            if (!Schema::hasColumn('racks', 'current_job_id')) {
