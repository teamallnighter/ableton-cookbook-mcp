                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open"
                        ...
                        <div class="py-1">
                            ...
                            <a href="{{ route('favorites') }}" class="flex items-center px-4 py-2 text-sm text-black hover:bg-gray-100 transition-colors {{ request()->routeIs('favorites') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden bg-white border-t-2 border-black">
        ...
        <div class="pt-4 pb-1 border-t-2 border-black">
            ...
            <div class="mt-3 px-2 space-y-1">
                ...
                <a href="{{ route('favorites') }}" class="flex items-center px-3 py-2 text-base font-medium text-black hover:bg-gray-100 rounded-md transition-colors {{ request()->routeIs('favorites') ? 'bg-vibrant-purple text-white' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                    </svg>
                    Favorites
